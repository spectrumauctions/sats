...
public class MRMRegionalBidderSetup extends MRMBidderSetup {
     ...
     * @return
     */
    public MRMRegionsMap.Region drawHome(MRMWorld world, UniformDistributionRNG rng) {
     ...
     * @return
     */
    public ImmutableSortedMap<Integer, BigDecimal> drawDistanceDiscounts(MRMWorld world, MRMRegionsMap.Region home, UniformDistributionRNG rng) {
