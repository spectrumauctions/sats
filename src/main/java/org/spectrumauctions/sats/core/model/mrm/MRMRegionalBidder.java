...
public final class MRMRegionalBidder extends MRMBidder {
    ...
    transient MRMRegionsMap.Region home;
    ...
    public Map<MRMRegionsMap.Region, BigDecimal> gammaFactors(Bundle<MRMLicense> bundle) {
        ...
        for(MRMRegionsMap.Region region : getWorld().getRegionsMap().getRegions()){
    ...
    public void refreshReference(World world){
        ...
        MRMRegionsMap.Region homeCandidate = getWorld().getRegionsMap().getRegion(homeId);
