 ...
 */
package org.spectrumauctions.sats.core.model.bm.bvm;

import org.spectrumauctions.sats.core.model.bm.BMWorldSetup;
...
public final class BVMWorldSetup extends BMWorldSetup {
    ...
    public static class BVMWorldSetupBuilder extends BMWorldSetupBuilder{
        ...
        /* (non-Javadoc)
         * @see org.spectrumauctions.sats.core.model.bm.BMWorldSetupBuilder#build()
         */
        @Override
