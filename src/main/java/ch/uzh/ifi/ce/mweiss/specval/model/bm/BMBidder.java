...
public class BMBidder extends Bidder<BMLicense> implements GenericValueBidder<BMBand> {
    ...
    /* (non-Javadoc)
     * @see ch.uzh.ifi.ce.mweiss.specval.model.Bidder#getValue(ch.uzh.ifi.ce.mweiss.specval.model.Bundle)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ch.uzh.ifi.ce.mweiss.specval.model.Bidder#getWorld()
     */
    @Override
