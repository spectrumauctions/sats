 ...
 */
package ch.uzh.ifi.ce.mweiss.satsopt.model;
...
public class GenericAllocation<T extends GenericDefinition> implements Allocation<GenericValue<T>> {
    ...
    /* (non-Javadoc)
     * @see ch.uzh.ifi.ce.mweiss.satsopt.model.Allocation#getAllocatedItems(ch.uzh.ifi.ce.mweiss.specval.model.Bidder)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see ch.uzh.ifi.ce.mweiss.satsopt.model.Allocation#getBidders()
     */
    @Override
