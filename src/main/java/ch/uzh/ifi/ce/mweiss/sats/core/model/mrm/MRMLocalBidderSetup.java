...
public class MRMLocalBidderSetup extends MRMBidderSetup {
     ...
     * @return
     */
    public Set<Region> drawRegionsOfInterest(MRMWorld world, UniformDistributionRNG rng) {
        if(regionNotes == null){
    ...
    private Set<Region> pickPredeterminedRegions(MRMWorld world){
    ...
    private Set<Region> drawRegionsOfInterestRandomly(MRMWorld world, UniformDistributionRNG rng){
