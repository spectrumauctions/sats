...
import ch.uzh.ifi.ce.mweiss.specval.util.math.Function;
...
import ch.uzh.ifi.ce.mweiss.specval.util.random.GaussianDistributionRNG;
 ...
 *
 */
public final class MRMWorldSetup {
    ...
    private MRMWorldSetup(MRMWorldSetupBuilder builder) {
        super();
    ...
    public static class MRMWorldSetupBuilder{
     ...
     //       cornerPoints.put(BigDecimal.valueOf(2), BigDecimal.valueOf(1.4));
        ...
        public MRMWorldSetup build(){
            return new MRMWorldSetup(this);
