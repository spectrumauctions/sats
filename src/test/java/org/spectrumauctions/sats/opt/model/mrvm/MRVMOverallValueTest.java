...
// FIXME: Currently, this is not possible because we have abstracted the JOpt result away.
//  -> Think about whether it makes sense to enable access to this again and reactivate this test
