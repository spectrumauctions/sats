...
public class MRMBidderTest {
	...
	private MRMRegionsMap.Region region1 = mock(MRMRegionsMap.Region.class);
	private MRMRegionsMap.Region region2 = mock(MRMRegionsMap.Region.class);
	...
	public void setup(){
		...
		when(setup.drawBeta(any(MRMRegionsMap.Region.class), any(UniformDistributionRNG.class))).thenReturn(BigDecimal.valueOf(0.2)); // Same Beta for all Regions
