...
public class MRMBidderTypeSpecificTest {
    ...
    public void localGammaValuesTestOnCompleteBundle(){
        ...
        Map<MRMRegionsMap.Region, BigDecimal> gammaValues = localBidder.gammaFactors(completeBundle);
        int interestRegionsCount = 0;
        for(Entry<MRMRegionsMap.Region, BigDecimal> gammaEntry : gammaValues.entrySet()){
    ...
    public void regionalGammaValuesTest(){
        ...
        Map<MRMRegionsMap.Region, BigDecimal> calculatedGammas = regionalBidder.gammaFactors(null);
        for(Entry<MRMRegionsMap.Region, BigDecimal> regionEntry : calculatedGammas.entrySet()){
