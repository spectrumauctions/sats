...
public class MRMWorldTest {
    ...
    public void selectAllLicensesOfRegionOnCompleteBundle(){
        Map<Region, Bundle<MRMLicense>> regionalBundles = MRMWorld.getLicensesPerRegion(completeBundle);
    ...
    public void capacityIsCorrectlyCalculatedCompleteRegionalBundle(){
        Map<Region, Bundle<MRMLicense>> regionalBundles = MRMWorld.getLicensesPerRegion(new Bundle<>(world.getLicenses()));
        ...
        for(Entry<Region, Bundle<MRMLicense>> regionalBundle : regionalBundles.entrySet()){
