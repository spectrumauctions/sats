...
import ch.uzh.ifi.ce.mweiss.sats.core.api.APITest;
import ch.uzh.ifi.ce.mweiss.sats.core.bidfile.CatsWriterTest;
import ch.uzh.ifi.ce.mweiss.sats.core.bidfile.JSONWriterTest;
import ch.uzh.ifi.ce.mweiss.sats.core.bidlang.generic.SimpleRandomOrder.SimpleRandomOrderTest;
import ch.uzh.ifi.ce.mweiss.sats.core.bidlang.generic.SizeOrderedPowerset.GenericSetsPickNTest;
import ch.uzh.ifi.ce.mweiss.sats.core.examples.BiddingLanguagesExample;
import ch.uzh.ifi.ce.mweiss.sats.core.examples.ParameterizingModelsExample;
import ch.uzh.ifi.ce.mweiss.sats.core.examples.SimpleModelAccessorsExample;
import ch.uzh.ifi.ce.mweiss.sats.core.instancehandling.SerializerTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.DefaultModel;
import ch.uzh.ifi.ce.mweiss.sats.core.model.bm.BMRandomnessTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.bm.BMValueTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.bm.SizeOrderedIteratorTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.bm.SizeOrderedPowersetTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.bm.bvm.BaseValueModel;
import ch.uzh.ifi.ce.mweiss.sats.core.model.cats.CATSRegionModel;
import ch.uzh.ifi.ce.mweiss.sats.core.model.gsvm.GSVMBidderTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.gsvm.GSVMWorldTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.lsvm.LSVMBidderTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.lsvm.LSVMWorldTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.lsvm.LocalSynergyValueModel;
import ch.uzh.ifi.ce.mweiss.sats.core.model.mrm.*;
import ch.uzh.ifi.ce.mweiss.sats.core.model.srm.SRMTest;
import ch.uzh.ifi.ce.mweiss.sats.core.model.srm.SingleRegionModel;
import ch.uzh.ifi.ce.mweiss.sats.core.util.file.FilePathUtils;
import ch.uzh.ifi.ce.mweiss.sats.core.bidlang.generic.SizeOrderedPowerset.GenericPowersetTest;
import ch.uzh.ifi.ce.mweiss.sats.core.bidlang.generic.XORQtoXORTest;
...
import ch.uzh.ifi.ce.mweiss.sats.core.model.srm.SRVMRandomnessTest;
