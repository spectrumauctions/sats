 ...
 */
package ch.uzh.ifi.ce.mweiss.sats.core.instancehandling;
...
import ch.uzh.ifi.ce.mweiss.sats.core.TestSuite;
import ch.uzh.ifi.ce.mweiss.sats.core.model.Bidder;
import ch.uzh.ifi.ce.mweiss.sats.core.model.DefaultModel;
import ch.uzh.ifi.ce.mweiss.sats.core.util.instancehandling.InstanceHandler;
...
public class SerializerTest {
    ...
    public <W extends World, B extends Bidder<?>> void  testBidderSerializability(DefaultModel<W, B> model){
        ...
        Set<Bidder<?>> originalPopulation = new HashSet<Bidder<?>>(model.createPopulation(world, rng.nextLong()));
